...
//    entity.setUser(dto.getUser());
    ...
    w.setName(entity.getWebinar().getName());
    w.setCode(entity.getWebinar().getCode());
    w.setStartTime(entity.getWebinar().getStartTime());
    w.setEndTime(entity.getWebinar().getEndTime());
    entity.setWebinar(w);
