  ...
  render() {
    ...
    return (
      <Dialog open={open} fullWidth={true} > 
        <div className="success-register-dialog" style={{ minHeight: '500px', maxWidth: '1000px' }}>
          <img
            style={{
              marginTop:'10%',
              marginLeft:'auto',
          ...
          />
          <section className="alignCenter" style={{textAlign:'center'}}>
            <h6 className="fs-24">
            ...
            >
              ...
              <Grid item xs={6} style={{ lineHeight: '200px' }}>
                <Button
                  variant="contained"
                  color="primary"
                  className="MuiGrid-spacing-xs-1"
