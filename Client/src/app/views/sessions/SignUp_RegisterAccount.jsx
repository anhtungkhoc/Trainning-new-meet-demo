          ...
          <div className="p-8">
              ...
              <Grid container>
                <Grid item lg={2} md={2} sm={2} xs={12}>
                  <div className="p-32 flex flex-center bg-light-gray flex-middle h-100">
                    <img
                      src={ConstantList.ROOT_PATH + "assets/images/logo345.png"}
                      alt=""
                    />
                  </div>
                </Grid>
                <Grid item lg={10} md={10} sm={10} xs={12} container spacing={2}>
                  ...
                  <Grid item lg={12} md={12} sm={12} xs={12} className="m-10" container spacing={2}>
            ...
            {showRegisterSuccessDialog && (
              <RegisterSuccessDialog
                ...
                open={showRegisterSuccessDialog}
              />
            )}
          </div>
        </div>
