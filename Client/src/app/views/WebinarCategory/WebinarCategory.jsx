...
import { deleteItem, searchByPage, getItemById } from "./WebinarCategoryService";
import WebinarCategoryDialog from "./WebinarCategoryDialog";
...
class WebinarCategory extends Component {
  state = {
    keyword: '',
    rowsPerPage: 10,
    page: 0,
    ...
    shouldOpenAddWebinarCategoryDialog: false,
  ...
  render() {
    ...
    let columns = [
      { title: t("webinarCategory.category"), field: "category.name", width: "150" },
      { title: t("webinarCategory.webinar"), field: "webinar.name", width: "150" },
      {
        title: t("Action"),
        field: "custom",
        align: "left",
      ...
      <div className="m-sm-30">
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            <div>
              {shouldOpenEditorDialog && (
                <WebinarCategoryDialog t={t} i18n={i18n}
